...
def get_memory_service():
    """Process-wide Memory Bank service pointing at Vertex AI Memory Bank."""
    ...
    memory_bank_id = os.environ.get("MEMORY_BANK_ID") or "5315419639692394496"
    from google.adk.memory import VertexAiMemoryBankService
    return VertexAiMemoryBankService(
        project=os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-01-39fe799c3cd6"),
        location="us-east1",
